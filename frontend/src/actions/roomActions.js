...
export const roomCreate = (name, maxcount, features1, features2, features3, features4, features5, rentperday, imageUrl1, imageUrl2, imageUrl3, type, description) => async (dispatch, getState) => {
      try {
            ...
            const { data } = await axios.post(`http://localhost:6500/api/rooms/createrooms`, { name, maxcount, features1, features2, features3, features4, features5, rentperday, imageUrl1, imageUrl2, imageUrl3, type, description })
...
export const allRooms = () => async (dispatch) => {
      try {
            ...
            const { data } = await axios.get('http://localhost:6500/api/rooms/allrooms')
...
export const getRoomDetails = (id) => async (dispatch, getState) => {
      try {
            ...
            const { data } = await axios.get(`http://localhost:6500/api/rooms/${id}`)
...
export const bookRoomDetails = (roomid) => async (dispatch) => {
      try {
            ...
            const { data } = await axios.post('http://localhost:6500/api/rooms/roomsbyId', { roomid })
...
export const deleteRoom = (id) => async (dispatch) => {
      try {
            ...
            await axios.delete(`http://localhost:6500/api/rooms/${id}`)
...
export const updateRoom = (rooms) => async (dispatch, getState) => {
      try {
            ...
            const { data } = await axios.put(`http://localhost:6500/api/rooms/${rooms._id}`, rooms)
