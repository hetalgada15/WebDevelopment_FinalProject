...
export const allConference = () => async (dispatch) => {
    try {
          ...
          const { data } = await axios.get('http://localhost:6500/api/conference/')
...
export const deleteConference = (id) => async (dispatch) => {
    try {
          ...
          await axios.delete(`http://localhost:6500/api/conference/${id}`)
...
export const updateConDetails = (conference) => async (dispatch) => {
      ...
      try {
            ...
            const { data } = await axios.put(`http://localhost:6500/api/conference/${conference._id}`, conference)
...
export const filterconference = (searchkey) => async dispatch => {
      ...
      try {
            ...
            const  response = await axios.get('http://localhost:6500/api/conference/')
