      ...
      useEffect(() => {
            if (conferenceInfo) {
                  Swal.fire('Successful', 'Successfully Inserted Conference Room', 'success').then(result => {
                        window.location.href = '/studEveMgt'
                  })
            }
                                                            ...
                                                            <div class="col-lg-10 col-xl-7 mx-auto">
                                                                  ...
                                                                  <form onSubmit={console.log("submitted form")}>
                                                                        <div class="form-group mb-3">
                                                                              < input id="Enter Studio Hall Name" type="text" placeholder="Enter Conference Room Name" required="" autofocus="" className="form-control " 
                                                                              value={conName}
